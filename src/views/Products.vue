<template>
	<div class="products">
        ...
        <div class="row h-100 justify-content-center align-items-center">
          <div class="col-md-6">
            <h3>Products Page</h3>
            <p>Qui voluptate deserunt sint.</p>
          </div>
          <div class="col-md-6">
            <img src="/img/svg/products.svg" alt="Dashboard Image" class="img-fluid">
          </div>
        </div>
      </div>
      ...
      <div class="product-test">
        ...
        <h3 class="float-left d-inline">Products List</h3>
        <button @click="addNew" class="btn btn-success float-right"><i class="fas fa-plus"></i> Add Product</button>
    ...
    firestore(){
      return{
        products: fstore.collection('products'),
      }
    },
